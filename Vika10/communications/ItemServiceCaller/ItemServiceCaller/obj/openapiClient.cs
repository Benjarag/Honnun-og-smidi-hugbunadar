...
namespace ItemServiceCaller
{
    ...
    public partial class openapiClient 
    {
        ...
        public System.Threading.Tasks.Task<Item> PostAsync(ItemCreateRequest body)
        {
        ...
        /// <returns>Successful Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Item> PostAsync(ItemCreateRequest body, System.Threading.CancellationToken cancellationToken)
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "422") 
                        {
                            ...
                            throw new ApiException<HTTPValidationError>("Validation Error", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
        ...
        /// <returns>Successful Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Item> GetAsync(string item_id)
        {
            return GetAsync(item_id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successful Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Item> GetAsync(string item_id, System.Threading.CancellationToken cancellationToken)
        {
            if (item_id == null)
                throw new System.ArgumentNullException("item_id");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/items/{item_id}");
